  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Berhasil memperbarui data portofolio!'),
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  ...
                  hintText: 'Tuliskan deskripsi proyek...',
                ),
              ...
              TextFormField(
                ...
                validator: (value) => value == null || value.isEmpty ? 'Tautan external wajib diisi' : null,
              ),
